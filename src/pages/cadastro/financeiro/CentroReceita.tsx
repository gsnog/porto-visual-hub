          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#3a3f5c] hover:bg-[#3a3f5c] cursor-default select-none">
                <TableHead className="!text-white font-medium text-center">Centro de Receita</TableHead>
                <TableHead className="!text-white font-medium text-center">Diretoria</TableHead>
                <TableHead className="!text-white font-medium text-center">Gerência</TableHead>
                <TableHead className="!text-white font-medium text-center">Departamento</TableHead>
