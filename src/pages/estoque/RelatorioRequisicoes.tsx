...
export default function RelatorioRequisicoes() {
  ...
  return (
    <SimpleFormWizard title="Relatório de Requisições">
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Configure os filtros para gerar o relatório de requisições</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent className="bg-popover">
                      <SelectItem value="req1">Ana F.</SelectItem>
                      <SelectItem value="req2">Carlos M.</SelectItem>
                      <SelectItem value="req3">Pedro S.</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
