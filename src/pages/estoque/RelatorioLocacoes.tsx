...
export default function RelatorioLocacoes() {
  ...
  return (
    <SimpleFormWizard title="Relatório de Locações">
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Configure os filtros para gerar o relatório de locações</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <Label className="text-sm font-medium">Locador</Label>
                  <Select>
                    <SelectTrigger className="form-input">
                      <SelectValue placeholder="---" />
                    </SelectTrigger>
                    <SelectContent className="bg-popover">
                      <SelectItem value="loc1">João Silva</SelectItem>
                      <SelectItem value="loc2">Maria Santos</SelectItem>
                      <SelectItem value="loc3">Carlos Pereira</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Número do contrato" className="form-input" />
                </div>
