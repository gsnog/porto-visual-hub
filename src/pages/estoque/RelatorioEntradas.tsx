...
export default function RelatorioEntradas() {
  ...
  return (
    <SimpleFormWizard title="Relatório de Entradas">
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Configure os filtros para gerar o relatório de entradas</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Número da NF" className="form-input" />
                </div>
